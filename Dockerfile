...
apt-get update && apt-get --no-install-recommends install -y python3-requests python3-paramiko \
libusb-dev libpython3.7-dev libcap2-bin libcurl3-gnutls curl libcurl4 && update-ca-certificates --fresh && rm -rf /var/lib/apt/lists/*  && \
